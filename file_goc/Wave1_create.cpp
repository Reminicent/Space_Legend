...
EnemyShip::EnemyShip(){}
void EnemyShip::get_ship(int shealth, int edam,float ebspeed)
{
...
{
    for(int i=1;i<=27;i++)if(enemy_Health[i]>0)
    {
...
void EnemyShip::Destroy_EnemyShip() {
    for(int i=1;i<=27;i++)
    {
...
bool EnemyShip::in_Wave1()
{
    return EnemyShip::in_Wave1();
}
