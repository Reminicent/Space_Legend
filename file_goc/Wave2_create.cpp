...
SDL_Rect enemyship2_wave2_Rect[3];
SDL_Rect current_healthbar2_rect_2[3];
SDL_Rect left_healthbar2_rect_2[3];
SDL_Rect healthbar2_rect_2[3];
...
int enemy2_maxHealth_2[3],enemy2_Health_2[3];

int enemybullet2_X_2[10],enemybullet2_W_2[10],enemybullet2_H_2[10];
float enemybullet2_Y_2[10];

SDL_Texture* ship_texture_2[19];
SDL_Texture* bullet_texture_2[19];
SDL_Texture* ship2_texture_2[4];
SDL_Texture* bullet2_texture_2[10];
...
void EnemyShip2::Create_enemyship_2(SDL_Renderer* renderer, const std::string& imagePath1,const std::string& imagePath2) {
    ...
    for(int i=1;i<=3;i++)ship2_texture_2[i] = SDL_CreateTextureFromSurface(renderer, ship_surface);
    for(int i=1;i<=9;i++)bullet2_texture_2[i] = SDL_CreateTextureFromSurface(renderer, bullet_surface);
...
void EnemyShip2::create_enemyship_position()
{
     ...
     for(int i=1;i<=3;i++)
     {
     enemyship2_wave2_Rect[i].x=210+540*(i-1);     enemyship2_wave2_Rect[i].y=15;
...
void EnemyShip2::create_HP_bar()
{
     ...
     for(int i=1;i<=3;i++)
     {
        ...
        healthbar2_rect_2[i].h = 4*enemyship2_wave2_Rect[i].h /5;
     }
}
void EnemyShip2::render_HP_bar()
{
    ...
    for(int i=1;i<=3;i++)if(enemy2_Health_2[i]>0)
    {
         ...
         } else if (enemy2_Health_2[i] >= 40 * enemy_maxHealth_2[i] / 100) {
            barColor2[i] = {255, 255, 0, 255};
         } else if (enemy2_Health_2[i] > 0){
         ...
         left_healthbar2_rect_2[i].h = healthbar2_rect_2[i].h - current_healthbar2_rect_2[i].h;
...
void EnemyShip2::create_enemybullet_position()
{
     ...
     for(int i=1;i<=3;i++)
     {
         enemybullet2_X_2[3*i-1]=(2*enemyship2_wave2_Rect[i].x+enemyship2_wave2_Rect[i].w-enemyship2_wave2_Rect[i].w/4)/2;
         enemybullet2_Y_2[3*i-1]=(float)(enemyship2_wave2_Rect[i].y+enemyship2_wave2_Rect[i].w/2);
         enemybullet2_W_2[3*i-1]=enemyship2_wave2_Rect[i].w/4;
         enemybullet2_H_2[3*i-1]=3*enemyship2_wave2_Rect[i].h/2;

         enemybullet2_X_2[3*i-2]=(2*enemyship2_wave2_Rect[i].x+enemyship2_wave2_Rect[i].w-enemyship2_wave2_Rect[i].w/4)/2 - 160;
         enemybullet2_Y_2[3*i-2]=(float)(enemyship2_wave2_Rect[i].y+enemyship2_wave2_Rect[i].w/2) ;
         enemybullet2_W_2[3*i-2]=enemyship2_wave2_Rect[i].w/4;
         enemybullet2_H_2[3*i-2]=3*enemyship2_wave2_Rect[i].h/2;

         enemybullet2_X_2[3*i]=(2*enemyship2_wave2_Rect[i].x+enemyship_wave2_Rect[i].w-enemyship_wave2_Rect[i].w/4)/2 + 160;
         enemybullet2_Y_2[3*i]=(float)(enemyship2_wave2_Rect[i].y+enemyship2_wave2_Rect[i].w/2);
         enemybullet2_W_2[3*i]=enemyship2_wave2_Rect[i].w/4;
         enemybullet2_H_2[3*i]=3*enemyship2_wave2_Rect[i].h/2;
     }
}
void EnemyShip2::bullet_fire(int sx,int sy)
{
    for (int i = 1; i <= 18; i++){
        ...
        if(enemybullet_Y_2[i]>=sy+20&&enemybullet_Y_2[i]<=sy+80)
            if(enemybullet_X_2[i]>=sx+20&&enemybullet_X_2[i]<=sx+50)
            {
    ...
    for (int i = 1; i <= 3; i++){
        enemybullet2_Y_2[3*i-2]+=0.2;
        if(enemybullet2_Y_2[3*i-2]+enemybullet2_H_2[3*i-2]-150>=sy&&enemybullet2_Y_2[3*i-2]+enemybullet2_H_2[3*i-2]-150<=sy+20)
            if(enemybullet2_X_2[3*i-2]>=sx+20&&enemybullet2_X_2[3*i-2]<=sx+80)
            {

                if(shealth<=edam*2&&enemy2_Health_2[i]!=0)shealth=0; else if(enemy2_Health_2[i]!=0)shealth-=edam*2;
                enemybullet2_X_2[3*i-2] = (2*enemyship2_wave2_Rect[i].x+enemyship2_wave2_Rect[i].w-enemyship2_wave2_Rect[i].w/4)/2 - 160;
                enemybullet2_Y_2[3*i-2] = (float)(enemyship2_wave2_Rect[i].y+enemyship2_wave2_Rect[i].w/2);
            }
            if (enemybullet2_Y_2[3*i-2] > 900){
                enemybullet2_X_2[3*i-2] = (2*enemyship2_wave2_Rect[i].x+enemyship2_wave2_Rect[i].w-enemyship2_wave2_Rect[i].w/4)/2 - 160;
                enemybullet2_Y_2[3*i-2] = (float)(enemyship2_wave2_Rect[i].y+enemyship2_wave2_Rect[i].w/2);
        }
    }
    for (int i = 1; i <= 3; i++){
        enemybullet2_Y_2[3*i-1]+=0.2;
        if(enemybullet2_Y_2[3*i-1]+enemybullet2_H_2[3*i-1]-150>=sy&&enemybullet2_Y_2[3*i-1]+enemybullet2_H_2[3*i-1]-150<=sy+20)
            if(enemybullet2_X_2[3*i-1]>=sx+20&&enemybullet2_X_2[3*i-1]<=sx+80)
            {
            ...
            if (enemybullet2_Y_2[3*i-1] > 900){
                enemybullet2_X_2[3*i-1] = (2*enemyship2_wave2_Rect[i].x+enemyship2_wave2_Rect[i].w-enemyship2_wave2_Rect[i].w/4)/2;
                enemybullet2_Y_2[3*i-1] = (float)(enemyship2_wave2_Rect[i].y+enemyship2_wave2_Rect[i].w/2);
        }
    }
    for (int i = 1; i <= 3; i++){
        enemybullet2_Y_2[3*i]+=0.2;
        if(enemybullet2_Y_2[3*i]+enemybullet2_H_2[3*i]-150>=sy&&enemybullet2_Y_2[3*i]+enemybullet2_H_2[3*i]-150<=sy+100)
            if(enemybullet2_X_2[3*i]>=sx&&enemybullet2_X_2[3*i]<=sx+100)
            {

                if(shealth<=edam*2&&enemy2_Health_2[i]!=0)shealth=0; else if(enemy2_Health_2[i]!=0)shealth-=edam*2;
                enemybullet2_X_2[3*i] = (2*enemyship2_wave2_Rect[i].x+enemyship2_wave2_Rect[i].w-enemyship2_wave2_Rect[i].w/4)/2 + 160;
                enemybullet2_Y_2[3*i] = (float)(enemyship2_wave2_Rect[i].y+enemyship2_wave2_Rect[i].w/2);
            }
            if (enemybullet2_Y_2[3*i] > 900){
                enemybullet2_X_2[3*i] = (2*enemyship2_wave2_Rect[i].x+enemyship2_wave2_Rect[i].w-enemyship2_wave2_Rect[i].w/4)/2 + 160;
                enemybullet2_Y_2[3*i] = (float)(enemyship2_wave2_Rect[i].y+enemyship2_wave2_Rect[i].w/2);
        }
    }
...
void EnemyShip2::bullet_render(SDL_Renderer* renderer) {
     ...
     for (int i = 1; i <= 3; i++)if(enemy2_Health_2[i]>0){
        bullet = {enemybullet2_X_2[3*i-2], enemybullet2_Y_2[3*i-2], enemybullet2_W_2[3*i-2], enemybullet2_H_2[3*i-2]};
        SDL_RenderCopy(renderer, bullet2_texture_2[3*i-2], NULL, &bullet);

        bullet = {enemybullet2_X_2[3*i-1], enemybullet2_Y_2[3*i-1], enemybullet2_W_2[3*i-1], enemybullet2_H_2[3*i-1]};
        SDL_RenderCopy(renderer, bullet2_texture_2[3*i-1], NULL, &bullet);

        bullet = {enemybullet2_X_2[3*i], enemybullet2_Y_2[3*i], enemybullet2_W_2[3*i], enemybullet2_H_2[3*i]};
        SDL_RenderCopy(renderer, bullet2_texture_2[3*i], NULL, &bullet);
            }
}
...
void EnemyShip2::Destroy_EnemyShip() {
    ...
    for(int i=1;i<=9;i++)SDL_DestroyTexture(bullet2_texture_2[i]);
}
