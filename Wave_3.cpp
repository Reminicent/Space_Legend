...
const float BULLET_SPEED = 0.045f;
...
int main(int argc, char* argv[]) {
    ...
    SDL_Window* window = SDL_CreateWindow("Moving Square", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
    ...
    const int square = 27;    float coorX=30,coorY=20;   int i=0;
